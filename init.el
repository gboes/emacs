...
(doom! :input
       ...
       ;; vc-gutter         ; vcs diff in the fringe -- cool but can be slowing things down
       ...
       ;; snippets          ; my elves. They type so I don't have to ; 1 sec startup time
       ...
       (latex +auctex-latexmk +adaptive-wrap +company-auctex +company-reftex)             ; writing papers in Emacs has never been so fun
       ;;lean
       ;;factor
       ...
       ;;scala             ; java, but good
       scheme            ; a fully conniving family of lisps ; for Abelson Programming course
